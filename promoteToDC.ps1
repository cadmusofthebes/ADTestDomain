...
.PARAMETER domain
The domain parameter will be the name of your domain
.PARAMETER disable
This will disable the automatic start of the server tools when signing in as an admin
.PARAMETER static
This will set a static IP address for the server
